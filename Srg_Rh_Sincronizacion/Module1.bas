...
Public Ubicacion_Usuario As String          'Almacena la ubicación del usuario
...
Public Antiguedad_Anticipos_Proveedores As Integer  'Antigüedad para validar el alta de anticipos de proveedores
'Seguridad
...
'CAUSA_MODIFICO: Se agregó otra función para obtener la ruta de mis documentos
'*******************************************************************************
